// referenceEngine.js - Enhanced with response logging, smart fallback, and debug metadata improvements
...
async function generateReference() {
  ...
  document.getElementById("debugOutput").value = JSON.stringify({ missingFields, fetchedData, logs }, null, 2);
